...
**Intermediate Results Security**: The preprocessing module saves data objects using Python's pickle format. Pickle files from untrusted sources could potentially execute arbitrary code when loaded. Always ensure that:

1. Intermediate results are only generated by trusted preprocessing runs
2. Intermediate results directories have appropriate file permissions
3. You only load intermediate results that you or your team created
4. You do not share intermediate results directories publicly

For additional security, consider:
- Setting restrictive file permissions on intermediate results directories (e.g., chmod 700)
- Using separate BIDS roots for different projects
- Regularly cleaning up old intermediate results
